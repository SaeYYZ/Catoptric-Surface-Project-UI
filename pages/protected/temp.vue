...
const getDashboardLastestSelection = async () => {
  ...
  const _topRightMirrors = createPanelWithMirrorSelection(161, 241);
  topRightMirrors.value = _topRightMirrors;
  const _bottomLeftMirrors = createPanelWithMirrorSelection(241, 417);
  bottomLeftMirrors.value = _bottomLeftMirrors;
  const _bottomRightMirrors = createPanelWithMirrorSelection(417, 593);
...
.bottom-left {
  display: grid;
  grid-template-columns: 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px 50px;
  grid-template-rows: 45px 45px 45px 45px 45px 45px 45px 45px 45px 45px 45px;
}
